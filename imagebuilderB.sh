...
custom_packages() {
    ...
    local other_packages=(
        ...
        "modemband|https://downloads.immortalwrt.org/releases/packages-${cur_ver}/${ARCH_3}/packages"
        "luci-app-modemband|https://downloads.immortalwrt.org/releases/packages-${cur_ver}/${ARCH_3}/luci"
        "luci-app-sms-tool-js|https://downloads.immortalwrt.org/releases/packages-${cur_ver}/${ARCH_3}/luci"
    ...
    echo -e "${STEPS} Mengunduh paket-paket khusus: OpenClash, Passwall, passwal2, Nikki..."
...
rebuild_firmware() {
    ...
    packages+=" tailscale luci-app-tailscale  luci-app-droidnet luci-app-ipinfo luci-theme-initials luci-theme-argon luci-app-argon-config luci-theme-hj luci-app-huawei-hilink"
    packages+=" luci-app-diskman smartmontools kmod-usb-storage kmod-usb-storage-uas ntfs-3g"
    packages+=" internet-detector luci-app-internet-detector internet-detector-mod-modem-restart vnstat2 vnstati2 netdata"
